...
{
	public abstract class trn_item_pdb_catalog_branches_base
	{
		public Int64 spa_id { get; set; }
		public String child_svc_code { get; set; }
		public String parent_svc_code { get; set; }

		public trn_item_pdb_catalog_branches CreateBaseRec(SqlDataReader r)
		{
			trn_item_pdb_catalog_branches n = new trn_item_pdb_catalog_branches();

			if (!r.IsDBNull(0)) n.spa_id = r.GetInt64(0);
			if (!r.IsDBNull(1)) n.child_svc_code = r.GetString(1);
			if (!r.IsDBNull(2)) n.parent_svc_code = r.GetString(2);
